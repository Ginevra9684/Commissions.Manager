...
namespace Commissions.Manager.Migrations
{
    ...
    [Migration("20241220144421_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Commissions.Manager.Commissions.Commission", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.PrimitiveCollection<string>("EmployeeIds")
            ...
            modelBuilder.Entity("Commissions.Manager.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.PrimitiveCollection<string>("CommissionIds")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Commissions.Manager.Employees.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Commissions.Manager.Employees.EmployeeCommission", b =>
                {
                    ...
                    b.HasKey("EmployeeId", "CommissionId");
            ...
            modelBuilder.Entity("Commissions.Manager.Employees.EmployeeCommission", b =>
                {
                    b.HasOne("Commissions.Manager.Commissions.Commission", null)
                        .WithMany()
                        .HasForeignKey("CommissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Commissions.Manager.Employees.Employee", null)
                        .WithMany()
