...
namespace Commissions.Manager.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommissionIds = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEmployeesCommissions", x => new { x.EmployeeId, x.CommissionId });
                    table.ForeignKey(
                        name: "FK_AppEmployeesCommissions_AppCommissions_CommissionId",
                        column: x => x.CommissionId,
                        principalTable: "AppCommissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppEmployeesCommissions_AppEmployees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppEmployeesCommissions_CommissionId",
                table: "AppEmployeesCommissions",
                column: "CommissionId");

            migrationBuilder.CreateIndex(
                name: "IX_AppEmployeesCommissions_EmployeeId",
                table: "AppEmployeesCommissions",
                column: "EmployeeId");
